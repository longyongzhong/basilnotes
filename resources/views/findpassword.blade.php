                ...
                $.post("{{url('/checkemail')}}",{email:e},function (data,status) {
                    if (status=="success"){
                        if (data=="havesame"){
                            ...
                            $("#emailinfo").text("您输入的邮箱还没有注册，请先注册！");
                            $("#email").focus();
        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="actived"><a href="{{url('/findpassword')}}">找回密码 <span class="sr-only">(current)</span></a></li>
                </ul>
        ...
        <div class="col-md-4 col-md-offset-4 loginbox" style="opacity: 0.8">
            <form method="post" action="">
                ...
                <div class="form-group">
                    ...
                    <input type="email"class="form-control" id="email" placeholder="在这里输入您注册时的邮箱" name="email">
                ...
                <div class="col-md-6 col-md-offset-3">
                    <button type="submit" id="reg" class="btn btn-success btn-block" onclick="return checkinput()">立即找回</button>
                </div>
            </form>
        </div>
