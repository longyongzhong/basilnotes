        ...
        <div class="col-md-4 col-md-offset-4 loginbox" style="opacity: 0.8">
            <form method="post" action="">
                ...
                <div class="form-group">
                    <label for="name">账号 <span class="glyphicon glyphicon-envelope"></span></label>
                    <input type="text" class="form-control" id="email" placeholder="在这里输入邮箱" name="name">
